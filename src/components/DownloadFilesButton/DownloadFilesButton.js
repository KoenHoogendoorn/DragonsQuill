...
import classes from './DownloadFilesButton.module.scss';
...
const DownloadFilesButton = (props) => {
  ...
  // -----------------------
    ...
    return (
        <div className={classes.DownloadFilesButton}>
            <Button clicked={downloadFileHandler} size="small" priority="primary" iconPlacement="left">
                <i className="far fa-save"></i>Download data
            </Button>
            <a className={classes.Hidden}
            download={fileName}
...
export default connect(mapStateToProps)(DownloadFilesButton);